...
from .classification_naive_mlp_cnn import NaiveCNN, NaiveMLP
...
def build_classification_model(
    ...
    if name == "naive_cnn":
        return NaiveCNN(in_channels=in_channels, num_classes=num_classes)

    if name == "naive_mlp":
        return NaiveMLP(in_channels=in_channels, image_size=image_size, num_classes=num_classes)
    ...
    raise ValueError(
        ...
        "Use one of: simple_cnn, simple_mlp, naive_cnn, naive_mlp, ode_cnn, resnet18, "
        "resnet18_gelu, resnet34, resnet34_gelu, resnet34_cifar, resnet34_cifar_gelu, vit_b16"
    )
