...
LOG_DIR="${LOG_DIR:-results/logs/time_series_weather_ssml_v6}"
mkdir -p "$LOG_DIR"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/time_series_weather_ssml_rescue_v6}"
...
CASE_SPECS="${CASE_SPECS:-a025_t10:0.25:0.0:0.02:0.01 a05_t10:0.5:0.0:0.02:0.01 a025_t15:0.25:0.0:0.02:0.015 a05_t15:0.5:0.0:0.02:0.015}"
...
echo "[time_series_weather_ssml_v6] output_root=$OUTPUT_ROOT"
echo "[time_series_weather_ssml_v6] gpu=$GPU seeds=$SEEDS"
echo "[time_series_weather_ssml_v6] model_pairs=$MODEL_PAIRS"
echo "[time_series_weather_ssml_v6] warmup=$WARMUP_EPOCHS decay=${IMITATION_DECAY_START_EPOCH}->${IMITATION_DECAY_END_EPOCH} min_scale=$IMITATION_DECAY_MIN_SCALE"
echo "[time_series_weather_ssml_v6] one_way=$ONE_WAY regression_imitation_loss=$REGRESSION_IMITATION_LOSS"
echo "[time_series_weather_ssml_v6] gate=$SSML_GATE_SCORE_MODE transform=$SSML_SCORE_TRANSFORM guidance=$SSML_GUIDANCE_MODE"
echo "[time_series_weather_ssml_v6] case_specs=$CASE_SPECS"
