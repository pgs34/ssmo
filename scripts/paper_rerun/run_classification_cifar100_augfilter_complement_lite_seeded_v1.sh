...
LOG_DIR="${LOG_DIR:-results/logs/classification_cifar100_augfilter_complement_lite_seeded_v1}"
mkdir -p "$LOG_DIR"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/classification_cifar100_augfilter_complement_lite_seeded_v1}"
CLASSIFICATION_IMITATION_LOSS="${CLASSIFICATION_IMITATION_LOSS:-kl}"
CASE_SPECS="${CASE_SPECS:-pcu_lite_df10_m80_x05:peer_confident_student_uncertain:0.20:0.05:0.012:0.020:0.38:0.020:5:7.0:0.0004:0.82:0.90:2:0.50:0.02:0.72:0.90:0.03:4:18:55:0.30:0.10:0.80:0.50 pcu_lite_df15_m85_x08:peer_confident_student_uncertain:0.22:0.05:0.011:0.020:0.39:0.022:5:7.0:0.0004:0.84:0.85:2:0.50:0.02:0.74:0.91:0.03:6:22:65:0.25:0.15:0.85:0.80 uh_lite_df10_m80_x05:useful_hard_sample_confident:0.24:0.04:0.012:0.020:0.35:0.020:4:6.0:0.0004:0.85:0.80:2:0.50:0.03:0.72:0.92:0.03:4:18:55:0.30:0.10:0.80:0.50 uh_lite_df15_m85_x08:useful_hard_sample_confident:0.22:0.04:0.011:0.020:0.36:0.020:4:6.0:0.0004:0.84:0.82:2:0.50:0.03:0.74:0.92:0.03:6:22:65:0.25:0.15:0.85:0.80}"
...
run_case() {
  ...
  shift
  run_locked_job \
    "classification_cifar100_augfilter_complement_lite_seeded_v1/$label" \
    "classification_cifar100_augfilter_complement_lite_seeded_v1/$label" \
    "$LOG_DIR/$label.log" \
    env \
...
echo "[classification_cifar100_augfilter_complement_lite_seeded_v1] output_root=$OUTPUT_ROOT"
echo "[classification_cifar100_augfilter_complement_lite_seeded_v1] gpu=$GPU seeds=$SEEDS epochs=$EPOCHS batch_size=$BATCH_SIZE"
echo "[classification_cifar100_augfilter_complement_lite_seeded_v1] best_ckpt_template=$BEST_CKPT_TEMPLATE"
echo "[classification_cifar100_augfilter_complement_lite_seeded_v1] peer_best_ckpt_template=$PEER_BEST_CKPT_TEMPLATE"
echo "[classification_cifar100_augfilter_complement_lite_seeded_v1] case_specs=$CASE_SPECS"
...
echo "[classification_cifar100_augfilter_complement_lite_seeded_v1] done"
