...
LOG_DIR="${LOG_DIR:-results/logs/time_series_weather_ssml_v18}"
mkdir -p "$LOG_DIR"

DEVICE="${DEVICE:-cuda}"
GPU="${GPU:-0}"
SEEDS="${SEEDS:-0 1 2}"
MODEL_PAIRS="${MODEL_PAIRS:-patchtst:dlinear transformer:dlinear}"
EPOCHS="${EPOCHS:-60}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/time_series_weather_ssml_rescue_v18}"
...
SSML_IMITATION_SPACE="${SSML_IMITATION_SPACE:-delta}"
...
SSML_ADAPTIVE_DENSE_MAX_SELECTED_RATIO="${SSML_ADAPTIVE_DENSE_MAX_SELECTED_RATIO:-0.25}"
...
CASE_SPECS="${CASE_SPECS:-delta_cap10:0.06:0.003:0.00:0.10:0.10:3:3:0.20:0.0005 delta_cap15:0.05:0.003:0.00:0.12:0.15:3:5:0.20:0.0005 delta_cap20:0.04:0.002:0.00:0.15:0.20:5:5:0.15:0.0001}"
...
echo "[time_series_weather_ssml_v18] output_root=$OUTPUT_ROOT"
echo "[time_series_weather_ssml_v18] gpu=$GPU seeds=$SEEDS"
echo "[time_series_weather_ssml_v18] model_pairs=$MODEL_PAIRS"
echo "[time_series_weather_ssml_v18] case_specs=$CASE_SPECS"
