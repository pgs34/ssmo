...
LOG_DIR="${LOG_DIR:-results/logs/time_series_weather_ssml_v7}"
mkdir -p "$LOG_DIR"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/time_series_weather_ssml_rescue_v7}"
...
CASE_SPECS="${CASE_SPECS:-trim90_a01_t05:0.1:0.0:0.02:0.05:0.90 trim90_a025_t03:0.25:0.0:0.02:0.03:0.90 trim85_a01_t05:0.1:0.0:0.02:0.05:0.85}"
...
echo "[time_series_weather_ssml_v7] output_root=$OUTPUT_ROOT"
echo "[time_series_weather_ssml_v7] gpu=$GPU seeds=$SEEDS"
echo "[time_series_weather_ssml_v7] model_pairs=$MODEL_PAIRS"
echo "[time_series_weather_ssml_v7] warmup=$WARMUP_EPOCHS decay=${IMITATION_DECAY_START_EPOCH}->${IMITATION_DECAY_END_EPOCH} min_scale=$IMITATION_DECAY_MIN_SCALE"
echo "[time_series_weather_ssml_v7] one_way=$ONE_WAY regression_imitation_loss=$REGRESSION_IMITATION_LOSS"
echo "[time_series_weather_ssml_v7] gate=$SSML_GATE_SCORE_MODE transform=$SSML_SCORE_TRANSFORM topk_scope=$SSML_TOPK_SCOPE guidance=$SSML_GUIDANCE_MODE"
echo "[time_series_weather_ssml_v7] case_specs=$CASE_SPECS"
