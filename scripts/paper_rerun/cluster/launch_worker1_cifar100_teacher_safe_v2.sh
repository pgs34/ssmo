...
LOG_DIR="${LOG_DIR:-results/logs/classification_cifar100_teacher_safe_v2/worker1}"
mkdir -p "$LOG_DIR"

run_logged_job \
  "worker1/cifar100_teacher_safe_v2" \
...
echo "[worker1_cifar100_teacher_safe_v2] job finished"
