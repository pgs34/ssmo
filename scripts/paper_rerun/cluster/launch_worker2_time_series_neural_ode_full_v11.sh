...
OUTPUT_ROOT="${TIME_SERIES_OUTPUT_ROOT:-results/time_series_neural_ode_full_v11}" \
...
run_logged_job \
  "worker2/time_series_neural_ode_full_v11_gpu${TIME_SERIES_GPU:-0}" \
  "$LOG_DIR/time_series_neural_ode_full_v11_gpu${TIME_SERIES_GPU:-0}.log" \
  bash scripts/paper_rerun/run_time_series_neural_ode_v11.sh

echo "[worker2_time_series_neural_ode_full_v11] job finished"
