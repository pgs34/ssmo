...
LOG_DIR="${LOG_DIR:-results/logs/classification_cifar100_augfilter_v1}"
mkdir -p "$LOG_DIR"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/classification_cifar100_augfilter_v1}"
CLASSIFICATION_IMITATION_LOSS="${CLASSIFICATION_IMITATION_LOSS:-kl}"
CASE_SPECS="${CASE_SPECS:-uhconf_pb24_thr35_gap20_augmin72_augmax92_agap03:useful_hard_sample_confident:0.24:0.04:0.012:0.020:0.35:0.020:4:6.0:0.0004:0.85:0.80:2:0.50:0.03:0.72:0.92:0.03 pcu_pb26_thr33_gap15_augmin68_augmax95_agap02:peer_confident_student_uncertain:0.26:0.04:0.012:0.015:0.33:0.015:4:6.0:0.0004:0.90:0.75:2:0.50:0.03:0.68:0.95:0.02 uhconf_pb22_thr38_gap25_augmin75_augmax90_agap04:useful_hard_sample_confident:0.22:0.05:0.014:0.025:0.38:0.025:5:6.0:0.0005:0.82:0.90:2:0.50:0.02:0.75:0.90:0.04}"
...
run_case() {
  ...
  run_locked_job \
    ...
    "classification_cifar100_augfilter_v1/$label" \
    "$LOG_DIR/$label.log" \
    env \
...
echo "[classification_cifar100_augfilter_v1] gpu=$GPU seeds=$SEEDS"
echo "[classification_cifar100_augfilter_v1] output_root=$OUTPUT_ROOT"
echo "[classification_cifar100_augfilter_v1] init_checkpoint_template=$INIT_CHECKPOINT_TEMPLATE"
echo "[classification_cifar100_augfilter_v1] peer_init_checkpoint_template=$PEER_INIT_CHECKPOINT_TEMPLATE"
echo "[classification_cifar100_augfilter_v1] case_specs=$CASE_SPECS"

for spec in $CASE_SPECS; do
  IFS=':' read -r label gate_mode topk_ratio alpha lambda margin prob_threshold prob_gap per_class_budget distill_temperature anchor_weight student_true_prob_max aug_weight aug_shift aug_flip aug_noise peer_aug_min student_aug_max aug_gap_min <<< "$spec"
  run_case \
    "$label" \
