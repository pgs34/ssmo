...
LOG_DIR="${LOG_DIR:-results/logs/classification_ssml_reweight_v4}"
mkdir -p "$LOG_DIR"
...
EPOCHS="${EPOCHS:-100}"
OUTPUT_ROOT="${OUTPUT_ROOT:-results/classification_ssml_reweight_v4}"
DOWNLOAD="${DOWNLOAD:-1}"

CIFAR10_TOPKS="${CIFAR10_TOPKS:-0.1 0.2}"
CIFAR100_TOPKS="${CIFAR100_TOPKS:-0.02 0.05}"
...
echo "[classification_ssml_reweight_v4] output_root=$OUTPUT_ROOT"
echo "[classification_ssml_reweight_v4] gpu=$GPU datasets=$DATASETS seeds=$SEEDS"
echo "[classification_ssml_reweight_v4] cifar10_topks=$CIFAR10_TOPKS"
echo "[classification_ssml_reweight_v4] cifar100_topks=$CIFAR100_TOPKS"
echo "[classification_ssml_reweight_v4] ssml_gate_score_mode=$SSML_GATE_SCORE_MODE"
echo "[classification_ssml_reweight_v4] ssml_score_transform=$SSML_SCORE_TRANSFORM"
echo "[classification_ssml_reweight_v4] ssml_guidance_mode=$SSML_GUIDANCE_MODE ssml_peer_correct_only=$SSML_PEER_CORRECT_ONLY"
